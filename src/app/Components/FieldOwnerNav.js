    ...
    return (
      ...
      <div className="flex justify-center items-center w-full">
        <ul className="object-center flex space-x-8 border-b-1 border-gray-400">
          ...
          <li className="inline hover:bg-gray-200 pb-3 pt-3"><a href="" className="px-6 py-3">Field Maintenance</a></li>
          <li className="inline hover:bg-gray-200 pb-3 pt-3"><a href="" className="px-6 py-3">Notifications</a></li>
