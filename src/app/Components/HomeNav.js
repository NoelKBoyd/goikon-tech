      ...
      <div className="flex justify-center items-center w-full pl-25">
        ...
        <div className="h-full flex items-center">
            <ul className="flex justify-center items-center space-x-8 pr-10 w-full">
                <li className="inline bg-gray-800 text-white px-5 pt-2 pb-2 rounded-md border border-black hover:bg-white hover:text-black duration-150"><a href="">Login</a></li>
                <li className="inline border border-white hover:border-black px-5 pt-2 pb-2 rounded-md duration-150"><a href="">Register</a></li>
            </ul>
        </div>
