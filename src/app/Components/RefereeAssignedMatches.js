...
export default function AssignedMatches() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-100">
            <main className="flex-grow flex items-start justify-center p-6 bg-gray-100">
                <div className="bg-white border-2 border-gray-300 rounded-lg shadow-lg p-6 w-full sm:w-96">
                    <h1 className="text-2xl font-bold text-center mb-4 text-gray-800">Assigned Matches</h1>

                    <button
                        onClick={fetchAssignedMatches}
                        className="w-full bg-black text-white py-2 rounded-md hover:bg-gray-800 transition duration-300"
                    >
                        Click to see the assigned matches
                    </button>
